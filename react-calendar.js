(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ReactCalendar"] = factory(require("moment"), require("react"));
	else
		root["ReactCalendar"] = factory(root["moment"], root["React"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Week = __webpack_require__(224);

	var _Week2 = _interopRequireDefault(_Week);

	var _Month = __webpack_require__(222);
	...
	var PagingCalendar = _react2.default.createClass({
	  displayName: 'PagingCalendar',

	  getInitialState: function getInitialState() {
	    return {
	      date: (0, _moment2.default)().startOf('year')
	    };
	  },

	  handlePrevYear: function handlePrevYear(e) {
	    e.preventDefault();
	    this.setState({
	  ...
	  handleNextYear: function handleNextYear(e) {
	    e.preventDefault();
	    this.setState({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'a',
	        { href: '#', className: 'prevYear', onClick: this.handlePrevYear },
	        'Prev Year'
	      ),
	      _react2.default.createElement(
	        'a',
	        { href: '#', className: 'nextYear', onClick: this.handleNextYear },
	        'Next Year'
	      ),
	      _react2.default.createElement(_Calendar2.default, { weekNumbers: true,
	        ...
	        mods: [{
	          ...
	          startDate: (0, _moment2.default)().add(3, 'days'),
	          endDate: (0, _moment2.default)().add(7, 'days'),
	          classNames: ['longEvent'],
	          component: ['day']
	        }, {
	          date: (0, _moment2.default)().add(3, 'days'),
	          classNames: ['appointment'],
	          component: ['day']
	        }, {
	          date: (0, _moment2.default)().add(4, 'days'),
	          classNames: ['event', 'warning'],
	          component: ['day'],
	          events: {
	            onClick: function onClick(date, e) {
	              return alert(date.format('dddd') + '\'s event!');
	            }
	          }
	        }, {
	          date: (0, _moment2.default)().add(5, 'days'),
	          classNames: ['event'],
	          component: ['day']
	        }, {
	          component: 'day',
	...
	_reactDom2.default.render(_react2.default.createElement(PagingCalendar, null), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _moment2 = __webpack_require__(71);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dateUtils = __webpack_require__(223);
	...
	var _Day = __webpack_require__(225);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/less-loader/index.js!./bootstrap-theme.less", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/less-loader/index.js!./bootstrap-theme.less");
